...
def issueViewAll():
    ...
    print("\n" + c.yellow("*****Stores with Known issues*****\n"))
    has_issues = False
...
while True:
    print("\nWELCOME TO CCT ISSUE TRACKER v2!")
    ...
    if choice == "REPORT":
        print("\n" + c.yellow("*****Report a new issue*****"))
        issueAdd()

    elif choice == "EDIT":
        print("\n" + c.yellow("*****Edit Details*****"))
        issueEdit()

    elif choice == "UPDATE":
        print("\n" + c.yellow("*****Update issue status*****"))
        issueUpdate()

    elif choice == "VIEW":
        print("\n" + c.yellow("*****View issues*****"))
        decision = input("Would you like to view all issues (a) or issues for a specific location (s)?: ").lower()
        if decision == "a":
            print("\n" + c.yellow("*****View all issues*****"))
            issueViewAll()
        elif decision == "s":
            print("\n" + c.yellow("*****View issues by location*****"))
            issueViewOne()
        else:
            print(c.red("Invalid selection."))

    elif choice == "SEARCH":
        print("\n" + c.yellow("*****Search for issues*****"))
        issueSearch()

    elif choice == "REMOVE":
        print("\n" + c.yellow("*****Remove an issue*****"))
        issueRemove()
